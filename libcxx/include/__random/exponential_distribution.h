...
public:
  ...
  public:
    ...
    _LIBCPP_HIDE_FROM_ABI _LIBCPP_CONSTEXPR_SINCE_CXX29 explicit param_type(result_type __lambda = 1) : __lambda_(__lambda) {}

    _LIBCPP_HIDE_FROM_ABI _LIBCPP_CONSTEXPR_SINCE_CXX29 result_type lambda() const { return __lambda_; }
...
public:
  ...
  _LIBCPP_HIDE_FROM_ABI _LIBCPP_CONSTEXPR_SINCE_CXX29 exponential_distribution() : exponential_distribution(1) {}
  _LIBCPP_HIDE_FROM_ABI _LIBCPP_CONSTEXPR_SINCE_CXX29 explicit exponential_distribution(result_type __lambda) : __p_(param_type(__lambda)) {}
#else
  _LIBCPP_HIDE_FROM_ABI explicit exponential_distribution(result_type __lambda = 1) : __p_(param_type(__lambda)) {}
#endif
  _LIBCPP_HIDE_FROM_ABI _LIBCPP_CONSTEXPR_SINCE_CXX29 explicit exponential_distribution(const param_type& __p) : __p_(__p) {}
  ...
  // property functions
  _LIBCPP_HIDE_FROM_ABI _LIBCPP_CONSTEXPR_SINCE_CXX29 result_type lambda() const { return __p_.lambda(); }
...
template <class _URNG>
_LIBCPP_CONSTEXPR_SINCE_CXX29 _RealType exponential_distribution<_RealType>::operator()(_URNG& __g, const param_type& __p) {
