...
public:
  ...
  public:
    ...
    _LIBCPP_HIDE_FROM_ABI _LIBCPP_CONSTEXPR_SINCE_CXX29 explicit param_type(result_type __alpha = 1, result_type __beta = 1)
        : __alpha_(__alpha), __beta_(__beta) {}

    _LIBCPP_HIDE_FROM_ABI _LIBCPP_CONSTEXPR_SINCE_CXX29 result_type alpha() const { return __alpha_; }
    _LIBCPP_HIDE_FROM_ABI _LIBCPP_CONSTEXPR_SINCE_CXX29 result_type beta() const { return __beta_; }
...
public:
  ...
  _LIBCPP_HIDE_FROM_ABI _LIBCPP_CONSTEXPR_SINCE_CXX29 gamma_distribution() : gamma_distribution(1) {}
  _LIBCPP_HIDE_FROM_ABI _LIBCPP_CONSTEXPR_SINCE_CXX29 explicit gamma_distribution(result_type __alpha, result_type __beta = 1)
      : __p_(param_type(__alpha, __beta)) {}
#else
  _LIBCPP_HIDE_FROM_ABI explicit gamma_distribution(result_type __alpha = 1, result_type __beta = 1)
      : __p_(param_type(__alpha, __beta)) {}
#endif
  _LIBCPP_HIDE_FROM_ABI _LIBCPP_CONSTEXPR_SINCE_CXX29 explicit gamma_distribution(const param_type& __p) : __p_(__p) {}
  ...
  // property functions
  _LIBCPP_HIDE_FROM_ABI _LIBCPP_CONSTEXPR_SINCE_CXX29 result_type alpha() const { return __p_.alpha(); }
  _LIBCPP_HIDE_FROM_ABI _LIBCPP_CONSTEXPR_SINCE_CXX29 result_type beta() const { return __p_.beta(); }
  ...
  friend _LIBCPP_HIDE_FROM_ABI _LIBCPP_CONSTEXPR_SINCE_CXX29 bool operator==(const gamma_distribution& __x, const gamma_distribution& __y) {
...
template <class _URNG>
_LIBCPP_CONSTEXPR_SINCE_CXX29 _RealType gamma_distribution<_RealType>::operator()(_URNG& __g, const param_type& __p) {
