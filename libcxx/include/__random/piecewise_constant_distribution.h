...
public:
  ...
  _LIBCPP_HIDE_FROM_ABI _LIBCPP_CONSTEXPR_SINCE_CXX29 piecewise_constant_distribution() {}
  template <class _InputIteratorB, class _InputIteratorW>
...
#ifndef _LIBCPP_CXX03_LANG
  template <class _UnaryOperation>
  _LIBCPP_HIDE_FROM_ABI _LIBCPP_CONSTEXPR_SINCE_CXX29 piecewise_constant_distribution(initializer_list<result_type> __bl, _UnaryOperation __fw)
      : __p_(__bl, __fw) {}
#endif // _LIBCPP_CXX03_LANG
  ...
  _LIBCPP_HIDE_FROM_ABI _LIBCPP_CONSTEXPR_SINCE_CXX29 explicit piecewise_constant_distribution(const param_type& __p) : __p_(__p) {}
...
_LIBCPP_CONSTEXPR_SINCE_CXX29 typename piecewise_constant_distribution<_RealType>::param_type&
...
template <class _RealType>
_LIBCPP_CONSTEXPR_SINCE_CXX29 void piecewise_constant_distribution<_RealType>::param_type::__init() {
...
template <class _RealType>
_LIBCPP_CONSTEXPR_SINCE_CXX29 piecewise_constant_distribution<_RealType>::param_type::param_type() : __b_(2), __densities_(1, 1.0), __areas_(1, 0.0) {
  __b_[1] = 1;
}

template <class _RealType>
template <class _InputIteratorB, class _InputIteratorW>
_LIBCPP_CONSTEXPR_SINCE_CXX29 piecewise_constant_distribution<_RealType>::param_type::param_type(
...
template <class _RealType>
template <class _URNG>
_LIBCPP_CONSTEXPR_SINCE_CXX29 _RealType piecewise_constant_distribution<_RealType>::operator()(_URNG& __g, const param_type& __p) {
