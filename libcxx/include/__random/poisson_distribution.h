...
public:
  ...
  public:
    ...
    _LIBCPP_HIDE_FROM_ABI _LIBCPP_CONSTEXPR_SINCE_CXX29 explicit param_type(double __mean = 1.0);

    _LIBCPP_HIDE_FROM_ABI _LIBCPP_CONSTEXPR_SINCE_CXX29 double mean() const { return __mean_; }
...
public:
  ...
  _LIBCPP_HIDE_FROM_ABI _LIBCPP_CONSTEXPR_SINCE_CXX29 poisson_distribution() : poisson_distribution(1.0) {}
  _LIBCPP_HIDE_FROM_ABI _LIBCPP_CONSTEXPR_SINCE_CXX29 explicit poisson_distribution(double __mean) : __p_(__mean) {}
#else
  _LIBCPP_HIDE_FROM_ABI explicit poisson_distribution(double __mean = 1.0) : __p_(__mean) {}
#endif
  _LIBCPP_HIDE_FROM_ABI _LIBCPP_CONSTEXPR_SINCE_CXX29 explicit poisson_distribution(const param_type& __p) : __p_(__p) {}
  ...
  // property functions
  _LIBCPP_HIDE_FROM_ABI _LIBCPP_CONSTEXPR_SINCE_CXX29 double mean() const { return __p_.mean(); }
  ...
  friend _LIBCPP_HIDE_FROM_ABI _LIBCPP_CONSTEXPR_SINCE_CXX29 bool operator==(const poisson_distribution& __x, const poisson_distribution& __y) {
...
_LIBCPP_CONSTEXPR_SINCE_CXX29 poisson_distribution<_IntType>::param_type::param_type(double __mean)
...
template <class _IntType>
template <class _URNG>
_LIBCPP_CONSTEXPR_SINCE_CXX29 _IntType poisson_distribution<_IntType>::operator()(_URNG& __urng, const param_type& __pr) {
