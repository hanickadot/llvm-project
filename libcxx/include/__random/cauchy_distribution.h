...
public:
  ...
  _LIBCPP_HIDE_FROM_ABI _LIBCPP_CONSTEXPR_SINCE_CXX29 cauchy_distribution() : cauchy_distribution(0) {}
  _LIBCPP_HIDE_FROM_ABI _LIBCPP_CONSTEXPR_SINCE_CXX29 explicit cauchy_distribution(result_type __a, result_type __b = 1)
      : __p_(param_type(__a, __b)) {}
#else
  _LIBCPP_HIDE_FROM_ABI explicit cauchy_distribution(result_type __a = 0, result_type __b = 1)
      : __p_(param_type(__a, __b)) {}
#endif
  _LIBCPP_HIDE_FROM_ABI _LIBCPP_CONSTEXPR_SINCE_CXX29 explicit cauchy_distribution(const param_type& __p) : __p_(__p) {}
  ...
  friend _LIBCPP_HIDE_FROM_ABI _LIBCPP_CONSTEXPR_SINCE_CXX29 bool operator==(const cauchy_distribution& __x, const cauchy_distribution& __y) {
...
template <class _URNG>
_LIBCPP_CONSTEXPR_SINCE_CXX29 inline _RealType cauchy_distribution<_RealType>::operator()(_URNG& __g, const param_type& __p) {
