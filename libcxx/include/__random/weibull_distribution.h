...
public:
  ...
  public:
    ...
    _LIBCPP_HIDE_FROM_ABI _LIBCPP_CONSTEXPR_SINCE_CXX29 explicit param_type(result_type __a = 1, result_type __b = 1) : __a_(__a), __b_(__b) {}
...
public:
  ...
  _LIBCPP_HIDE_FROM_ABI _LIBCPP_CONSTEXPR_SINCE_CXX29 weibull_distribution() : weibull_distribution(1) {}
  _LIBCPP_HIDE_FROM_ABI _LIBCPP_CONSTEXPR_SINCE_CXX29 explicit weibull_distribution(result_type __a, result_type __b = 1)
      : __p_(param_type(__a, __b)) {}
#else
  _LIBCPP_HIDE_FROM_ABI explicit weibull_distribution(result_type __a = 1, result_type __b = 1)
      : __p_(param_type(__a, __b)) {}
#endif
  _LIBCPP_HIDE_FROM_ABI _LIBCPP_CONSTEXPR_SINCE_CXX29 explicit weibull_distribution(const param_type& __p) : __p_(__p) {}
  ...
  friend _LIBCPP_HIDE_FROM_ABI _LIBCPP_CONSTEXPR_SINCE_CXX29 bool operator==(const weibull_distribution& __x, const weibull_distribution& __y) {
