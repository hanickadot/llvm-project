...
struct __shuffle {
  ...
  _LIBCPP_HIDE_FROM_ABI _LIBCPP_CONSTEXPR_SINCE_CXX29 _Iter operator()(_Iter __first, _Sent __last, _Gen&& __gen) const {
  ...
  _LIBCPP_HIDE_FROM_ABI _LIBCPP_CONSTEXPR_SINCE_CXX29 borrowed_iterator_t<_Range> operator()(_Range&& __range, _Gen&& __gen) const {
