...
struct __allocation_guard {
  ...
  constexpr _LIBCPP_HIDE_FROM_ABI explicit __allocation_guard(_AllocT __alloc, _Size __n)
      : __alloc_(std::move(__alloc)),
        __n_(__n),
        __ptr_(allocator_traits<_Alloc>::allocate(__alloc_, __n_)) // initialization order is important
  {}

  constexpr _LIBCPP_HIDE_FROM_ABI ~__allocation_guard() _NOEXCEPT { __destroy(); }

  constexpr _LIBCPP_HIDE_FROM_ABI __allocation_guard(const __allocation_guard&) = delete;
  constexpr _LIBCPP_HIDE_FROM_ABI __allocation_guard(__allocation_guard&& __other) _NOEXCEPT
  ...
  constexpr _LIBCPP_HIDE_FROM_ABI __allocation_guard& operator=(const __allocation_guard& __other) = delete;
  constexpr _LIBCPP_HIDE_FROM_ABI __allocation_guard& operator=(__allocation_guard&& __other) _NOEXCEPT {
  ...
  constexpr _LIBCPP_HIDE_FROM_ABI _Pointer
  ...
  constexpr _LIBCPP_HIDE_FROM_ABI _Pointer __get() const _NOEXCEPT { return __ptr_; }

private:
  constexpr _LIBCPP_HIDE_FROM_ABI void __destroy() _NOEXCEPT {
    if (__ptr_ != nullptr) {
